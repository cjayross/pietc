...
_lr_productions = [
  ...
  ('assign_expr -> NAME = STRING','assign_expr',3,'p_assign_expr','parse.py',101),
  ...
  ('compare_op -> <','compare_op',1,'p_compare_op','parse.py',123),
  ('compare_op -> >','compare_op',1,'p_compare_op','parse.py',124),
  ('compare_op -> LESSEROREQUAL','compare_op',1,'p_compare_op','parse.py',125),
  ('compare_op -> GREATEROREQUAL','compare_op',1,'p_compare_op','parse.py',126),
  ('compare_op -> EQUALS','compare_op',1,'p_compare_op','parse.py',127),
  ('compare_op -> NOTEQUALS','compare_op',1,'p_compare_op','parse.py',128),
  ('atom_expr -> term','atom_expr',1,'p_atom_expr','parse.py',132),
  ('atom_expr -> term + atom_expr','atom_expr',3,'p_atom_expr','parse.py',133),
  ('atom_expr -> term - atom_expr','atom_expr',3,'p_atom_expr','parse.py',134),
  ('term -> factor','term',1,'p_term','parse.py',143),
  ('term -> factor * term','term',3,'p_term','parse.py',144),
  ('term -> factor / term','term',3,'p_term','parse.py',145),
  ('term -> factor % term','term',3,'p_term','parse.py',146),
  ('factor -> atom','factor',1,'p_factor','parse.py',157),
  ('factor -> ( atom_expr )','factor',3,'p_factor','parse.py',158),
  ('atom -> INTEGER','atom',1,'p_atom','parse.py',165),
  ('atom -> NAME','atom',1,'p_atom','parse.py',166),
  ('atom -> TRUE','atom',1,'p_atom','parse.py',167),
  ('atom -> FALSE','atom',1,'p_atom','parse.py',168),
]
